...
#define BASE64_SIZE_T_MAX   ( (int) -1 ) /* SIZE_T_MAX is not standard */
 ...
 */
int mbedtls_base64_decode(unsigned char * dst, int dlen, int * olen,
    const unsigned char * src, int slen) {
    int i; /* index in source */
    int n; /* number of digits or trailing = in source */
