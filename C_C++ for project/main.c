...
//         setJsonItemData(&CtrlMainMeter_Manager.List, "list:%p;%d", CtrlMainMeter_Manager.List, 0);  // List 数组
//         setJsonItemData(&CtrlMainMeter_Manager.List.Class, ":%lp;%d", CtrlMainMeter_Manager.List.Class, 1);  // Class 对象
...
//         setJsonItemData(&CtrlCopyMeter_Manager.List, "list:%p;%d", CtrlCopyMeter_Manager.List, 0);             // List 数组
//         setJsonItemData(&CtrlCopyMeter_Manager.List.Class, ":%lp;%d", CtrlCopyMeter_Manager.List.Class, 1);                        // List 中的对象
