...
int main(int argc, char * argv[]) {
    ...
    strnew ArrayID = NEW_NAME("02345678903");
    ...
    if (1) {
        ...
        setJsonItemData(&WTRequestData[1], "eo:%s;%d", ArrayID.Name._char, 0);    // 02345678903
